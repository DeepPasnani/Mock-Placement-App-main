...
export const smsAPI = {
  ...
  sendTestReminder: (testId) => api.post(`/sms/test-reminder/${testId}`).then(r => r.data),
  sendBulk: (data) => api.post('/sms/send-bulk', data).then(r => r.data),
  getHistory: () => api.get('/sms/history').then(r => r.data),
};
...
// ── SSO ──────────────────────────────────────────────────
export const ssoAPI = {
  login:     ()          => api.post('/auth/sso/login').then(r => r.data),
  callback:  (data)      => api.post('/auth/sso/callback', data).then(r => r.data),
};

// ── LMS ──────────────────────────────────────────────────
export const lmsAPI = {
  syncRoster:      (data) => api.post('/lms/sync/roster', data).then(r => r.data),
  syncScores:      (data) => api.post('/lms/sync/scores', data).then(r => r.data),
  listCourses:     ()     => api.get('/lms/courses').then(r => r.data),
  getSyncLogs:     ()     => api.get('/lms/sync-logs').then(r => r.data),
  testConnection:  (data) => api.post('/lms/test-connection', data).then(r => r.data),
};

// ── ATS ──────────────────────────────────────────────────
export const atsAPI = {
  pushCandidate: (data) => api.post('/ats/push-candidate', data).then(r => r.data),
  getPushLogs:   ()     => api.get('/ats/push-logs').then(r => r.data),
};
...
export const webhooksAPI = {
  ...
  test:    (data)   => api.post('/webhooks/test', data).then(r => r.data),
};

// ── Video (Zoom/Meet) ───────────────────────────────────
export const videoAPI = {
  createZoom:     (data) => api.post('/video/zoom/create-meeting', data).then(r => r.data),
  createMeet:     (data) => api.post('/video/meet/create-meeting', data).then(r => r.data),
  createInterview: (data) => api.post('/video/create-interview', data).then(r => r.data),
};

// ── Payment ─────────────────────────────────────────────
export const paymentAPI = {
  getPlans:      ()       => api.get('/payment/plans').then(r => r.data),
  createCheckout: (data)  => api.post('/payment/create-checkout', data).then(r => r.data),
  razorpayOrder:  (data)  => api.post('/payment/razorpay/order', data).then(r => r.data),
  razorpayVerify: (data)  => api.post('/payment/razorpay/verify', data).then(r => r.data),
  subscribe:      (data)  => api.post('/payment/subscribe', data).then(r => r.data),
  getHistory:     ()       => api.get('/payment/history').then(r => r.data),
  createPlan:     (data)  => api.post('/payment/plans', data).then(r => r.data),
  updatePlan:     (id, data) => api.put(`/payment/plans/${id}`, data).then(r => r.data),
  deletePlan:     (id)    => api.delete(`/payment/plans/${id}`).then(r => r.data),
};
